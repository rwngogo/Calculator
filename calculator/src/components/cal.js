    ...
    render(){
        return(
            <div className="calculator">
                ...
                <Keypad>
                    <Button onClick={this.onClickHandler} label="C" value="clear" />
                    ...
                    <Button onClick={this.onClickHandler} label="x" value="*" />
                    ...
                    <Button onClick={this.onClickHandler} label="" value="null" />

                    <Button onClick={this.onClickHandler} label="-" value="-" />
                    <Button onClick={this.onClickHandler} label="+" size="2" value="+" />
                    <Button onClick={this.onClickHandler} label="=" size="2" value="equal" />
                </Keypad>
            </div>
        );
    }
